...
puts Restaurant.create([{name: 'McDonalds', address: 'Manhattan, NY', description: 'Our Burgers are best', phone: '4449991234', owner_id: 1}])
puts Restaurant.create([{name: 'Subway', address: 'Wall Stret, Manhattan, NY', description: 'Eat Healthy', phone: '4459991234', owner_id: 1}])
