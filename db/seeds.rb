...
owner1 = Owner.create(:name => 'Test Owner1', :email => 'egm0921@gmail.com', :password => 'test123')
...
owner2 = Owner.create(:name => 'Test Owner2', :email => 'emurphh@gmail.com', :password => 'test123')
