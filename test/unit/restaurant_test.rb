...
class RestaurantTest < ActiveSupport::TestCase
    ...
    test "should not save restaurant without description" do
        restaurant = Restaurant.new({:name => "Name", :address => "Address",:phone => "1-212-555-5555"})
        assert !restaurant.save, "Saved a restaurant without an description"
    end
